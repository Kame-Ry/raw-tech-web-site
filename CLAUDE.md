...
- AXIOM must **never** touch: `content/posts/`, `content/recipes/`, `content/tools/`, `themes/`, `public/`, `.github/`, `assets/`, or `archetypes/`
...
- AI Home is in the nav menu at weight 3 (between Posts and Tags)
